...
export default function StartLotteryPage(): JSX.Element {
    ...
    const [participants, setParticipants] = useState<Participant[]>([
        { nipp: "101", name: "John Doe", position: "Manager" },
        { nipp: "102", name: "Jane Smith", position: "Developer" },
        { nipp: "103", name: "Alice Johnson", position: "Designer" },
        { nipp: "104", name: "Bob Brown", position: "Analyst" },
        { nipp: "105", name: "Chris Lee", position: "Support" }
    ])
    ...
    const shuffleParticipants = (array: Participant[]) => {
    ...
    <div className="p-6 space-y-6 flex-1 flex flex-col font-poppins relative overflow-hidden h-screen">
        ...
        <div className="flex justify-center w-full">
            ...
            <div className="flex justify-center w-full">
                ...
                {currentParticipants.map((participant, colIndex) => (
                    <div key={colIndex} className="w-full max-w-[280px]">
                    <WinnerButton 
                        initialId={participant.nipp}
